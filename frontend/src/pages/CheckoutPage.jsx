          ...
          <div className="form-section">
            ...
            <div className="bonus-section">
              ...
              <label className="checkbox-label">
                ...
                />
                <span>Использовать бонусы для оплаты (до 20%)</span>
              </label>
              ...
              {useBonuses && (
                <div className="bonus-input-group">
                  ...
                  <input
                    type="number"
                    min="0"
                    max={Math.min(bonusBalance, getTotalPrice() * 0.2)}
                    step="0.01"
                    value={bonusToUse}
                    onChange={(e) => {
                  ...
                  <div className="bonus-hint">
                    Максимум 20% от суммы заказа: {Math.min(bonusBalance, getTotalPrice() * 0.2).toFixed(2)} BYN
                  </div>
                </div>
              )}
            </div>
